...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [LINUX_BASE] = LAYOUT_ansi_82(
        ...
        ESC_CTRL,  GUI_A,    ALT_S,    CTL_D,    SFT_F,    KC_G,     KC_H,     SFT_J,    CTL_K,    ALT_L,    GUI_SCLN, KC_QUOT,    KC_ENT,   KC_PGDN,
        KC_LSFT,  KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT,    KC_UP,
        KC_LCTL,  KC_LALT,  KC_LGUI,                      KC_SPC,                 KC_RGUI,  MO(LINUX_FN), KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT),
